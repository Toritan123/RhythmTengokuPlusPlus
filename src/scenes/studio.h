...
enum StudioSongsEnum {
    ...
    /* 44 */ STUDIO_SONG_DRUM_LESSON,
    /* 45 */ STUDIO_SONG_MARCHING_ORDERS_PRACTICE,
    /* 46 */ STUDIO_SONG_RAPMEN,
    /* 47 */ STUDIO_SONG_RAPWOMEN,
    /* 48 */ STUDIO_SONG_REMIX1,
    /* 49 */ STUDIO_SONG_REMIX2,
    /* 50 */ STUDIO_SONG_REMIX4,
    /* 51 */ STUDIO_SONG_KARATE_MAN_TEMPO_UP,
    /* 52 */ STUDIO_SONG_RHYTHM_TWEEZERS_TEMPO_UP,
    /* 53 */ STUDIO_SONG_MARCHING_ORDERS_TEMPO_UP,
    /* 54 */ STUDIO_SONG_SPACEBALL_TEMPO_UP,
    /* 55 */ STUDIO_SONG_CLAPPY_TRIO_TEMPO_UP,
    /* 56 */ STUDIO_SONG_REMIX1_TEMPO_UP,
