...
enum PerfectCampaignsEnum {
    ...
    /* 00 */ CAMPAIGN_KARATE_MAN_EXTRA = TOTAL_BASE_PERFECT_CAMPAIGNS,
    /* 01 */ CAMPAIGN_RHYTHM_TWEEZERS_EXTRA,
    /* 02 */ CAMPAIGN_MARCHING_ORDERS_EXTRA,
    /* 03 */ CAMPAIGN_SPACEBALL_EXTRA,
    /* 04 */ CAMPAIGN_CLAPPY_TRIO_EXTRA,
    /* 05 */ CAMPAIGN_REMIX_1_EXTRA,
    /* <insert new campaigns here> */
    /* -- */ TOTAL_EXTRA_PERFECT_CAMPAIGNS = (CAMPAIGN_REMIX_1_EXTRA + 1 - TOTAL_BASE_PERFECT_CAMPAIGNS),
    /* -- */ TOTAL_PERFECT_CAMPAIGNS = TOTAL_BASE_PERFECT_CAMPAIGNS + TOTAL_EXTRA_PERFECT_CAMPAIGNS
};
...
enum RhythmGameLevelsEnum {
    ...
    /* 54 */ LEVEL_LIVE_MENU,
    /* -- */ TOTAL_BASE_LEVELS,
    /* 00 */ LEVEL_KARATE_MAN_EXTRA = TOTAL_BASE_LEVELS, 
    /* 01 */ LEVEL_RHYTHM_TWEEZERS_EXTRA, 
    /* 02 */ LEVEL_MARCHING_ORDERS_EXTRA, 
    /* 03 */ LEVEL_SPACEBALL_EXTRA, 
    /* 04 */ LEVEL_CLAPPY_TRIO_EXTRA, 
    /* 05 */ LEVEL_REMIX_1_EXTRA,
    /* <insert new levels here> */
    /* -- */ TOTAL_EXTRA_LEVELS = (LEVEL_REMIX_1_EXTRA + 1 - TOTAL_BASE_LEVELS),
    /* -- */ TOTAL_LEVELS = TOTAL_BASE_LEVELS + TOTAL_EXTRA_LEVELS
};